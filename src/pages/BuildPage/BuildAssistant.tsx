    ...
    return <div className="w-full h-full">
        <div className="w-full h-[65px] flex justify-between items-center">
            ...
            <div className="flex space-x-4 pr-4 ">
                ...
                <Button className="w-[100px]">上线使用</Button>
            </div>
        </div>
        <div className="w-full h-[calc(100%-65px-50px)] flex">
                ...
                <div className="text-[#64748B] pl-20 ">
                    ...
                    <Accordion type="single" collapsible className="w-[550px]">
                        <AccordionItem value="1">
                            ...
                            <AccordionContent className=" flex space-x-4">
                                ...
                                <Input type="number" value={0.95} className="w-[100px]" />
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
                    <Accordion type="single" collapsible className="w-[550px]">
                        <AccordionItem value="1">
                            ...
                            <AccordionContent>
                                <Input type="number" value={3200} className="" />
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
                    <Accordion type="single" collapsible className="w-[550px]">
                    ...
                    <Accordion type="single" collapsible className="w-[550px]">
                        <AccordionItem value="1">
                            ...
                            <AccordionContent>
                                <Textarea className="w-[450px] h-[100px]"></Textarea>
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
                </div>
